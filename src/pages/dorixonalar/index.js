...
const Dorixonalar = () => {
  ...
  React.useEffect(() => {
    const sourceId = "earthquakesDorixona";
      ...
      for (let i = 0; i < 1000; i++) {
        ...
        let obj = {
          ...
          properties: {
            ...
            felt: null,
            tsunami: 0,
            descriptionClick: `Manzil: Toshkent, Shayxontoxir tumani, massiv Gulobod, Uyg'ur ko'chasi, ${i}-dorixona`,
            descriptionHover: `<h6 style='color: #fff'>Dorixona, ${i}</h6>`,
          },
          geometry: {
            type: "Point",
